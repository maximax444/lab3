...
public class Human implements Actions, Condition {
    ...
    public void goTo(Place place, Door d) {
        ...
        if (d.getDoorCondition()) {
            ...
            System.out.println(name + " пытается перейти в другой отсек корабля (" + place + "), но это весьма сложно сделать через закрытую дверь");
        }
    }
